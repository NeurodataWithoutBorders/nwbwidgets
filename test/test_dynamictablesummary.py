...
class DynamicSummaryTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.nwbfile.add_unit_column("sorting_quality", "the spike sorting quality of this unit")
        self.nwbfile.add_unit_column("quality", "the quality for the inference of this unit")
        self.nwbfile.add_unit_column("isi_violation", "the ISI violation ratio of this unit")
        self.nwbfile.add_unit_column("firing_rate", "the firing rate of this unit")
        self.nwbfile.add_unit_column("halfwidth", "the haldfwidth of this unit")
    ...
    def test_dynamyc_summary_table_widget(self):
        ...
        # select 3 real + 1 cat
        widget.show_labels.value = True
        cols_to_plot = (real_names[0], real_names[1], real_names[2], cat_names[0])
        widget.column_dropdown.value = cols_to_plot
        widget.show_labels.value = False
        ...
        # 4 real variables
        cols_to_plot = (real_names[0], real_names[1], real_names[2], real_names[3])
        widget.column_dropdown.value = cols_to_plot
        # this should trigger a reset of the dropdown
        assert len(widget.column_dropdown.value) == 0
